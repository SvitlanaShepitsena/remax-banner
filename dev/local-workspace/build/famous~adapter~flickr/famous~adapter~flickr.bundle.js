...
"use strict";
FamousFramework.includes("famous:adapter:flickr", "HEAD", [], function() {
    (function(){
        'use strict';
    ...
    (function(){
        ...
        FamousFramework.component('famous:service:http', 'HEAD', {
            ...
            events: {
                '$public': {
                    'base-url': function ($state, $payload) {
                        $state.set('base-url', $payload);
                    },
                    'url': function ($state, $payload) {
                        $state.set('url', $payload);
                    },
                    'method': function ($state, $payload) {
                        $state.set('method', $payload);
                    },
                    'headers': function ($state, $payload) {
                        $state.set('headers', $payload);
                    },
                    'token': function ($state, $payload) {
                        $state.set('token', $payload);
                    },
                    'parse-json': function ($state, $payload) {
                        $state.set('parse-json', $payload);
                    },
    ...
    (function(){
        ...
        FamousFramework.scene('famous:adapter:flickr', 'HEAD', {
            'dependencies': {
                'famous:service:http': 'HEAD',
            ...
            events: {
                ...
                '$public': {
                    ...
                    'api-key': function ($state, $payload) {
                        $state.set('apiKey', $payload);
                    }
                }
            },
            states: {
            ...
            tree: '<famous:service:http id="list-photos"></famous:service:http>\n    '
        });
    }());
    FamousFramework.markComponentAsReady("famous:adapter:flickr", "HEAD");
});