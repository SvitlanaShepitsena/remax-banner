...
"use strict";
FamousFramework.includes("famous:adapter:google-finance", "HEAD", [], function() {
    (function(){
        'use strict';
    ...
    (function(){
        ...
        FamousFramework.scene('famous:adapter:google-finance', 'HEAD', {
            'dependencies': {
                ...
                'famous:service:http': {
                    ...
                    'request': function (tickers) {
                        return {
                            ...
                            'parameters': { 'tickers': tickers.join(',') }
                        };
                    }
                }
            },
    ...
    FamousFramework.markComponentAsReady("famous:adapter:google-finance", "HEAD");
});