...
"use strict";
FamousFramework.includes("famous:adapter:open-weather-map", "HEAD", [], function() {
    (function(){
        'use strict';
    ...
    (function(){
        ...
        FamousFramework.scene('famous:adapter:open-weather-map', 'HEAD', {
            'dependencies': {
    ...
    FamousFramework.markComponentAsReady("famous:adapter:open-weather-map", "HEAD");
});