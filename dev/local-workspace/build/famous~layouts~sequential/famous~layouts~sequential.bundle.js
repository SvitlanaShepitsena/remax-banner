...
"use strict";
FamousFramework.includes("famous:layouts:sequential", "HEAD", ["famous/layouts/sequential/_constructor.js"], function() {
    (function(){
        'use strict';
    ...
    (function(){
        ...
        'use strict';
        FamousFramework.component('famous:layouts:sequential', 'HEAD', {
            ...
            behaviors: {
                ...
                '.sequential-layout': { 'style': {} },
                '.sequential-layout-item': { '$yield': true }
            },
            events: {
                '$public': {
            ...
            tree: '<famous:core:node class="sequential-layout">\n            <famous:core:node class="sequential-layout-item"></famous:core:node>\n        </famous:core:node>\n    '
        }).config({
            famousNodeConstructorName: 'SequentialLayout',
            includes: ['_constructor.js']
        });
    }());
    FamousFramework.markComponentAsReady("famous:layouts:sequential", "HEAD");
});