...
"use strict";
FamousFramework.includes("famous:service:location", "HEAD", [], function() {
    (function(){
        'use strict';
    ...
    (function(){
        'use strict';
        var TIMEOUT = 10000;
        FamousFramework.component('famous:service:location', 'HEAD', {
            ...
            states: { location: null }
        });
    }());
    FamousFramework.markComponentAsReady("famous:service:location", "HEAD");
});