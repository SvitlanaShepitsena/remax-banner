...
"use strict";
FamousFramework.includes("famous:service:timer", "HEAD", [], function() {
    (function(){
        'use strict';
    ...
    (function(){
        'use strict';
        var intervalMap = {};
        FamousFramework.component('famous:service:timer', 'HEAD', {
    ...
    FamousFramework.markComponentAsReady("famous:service:timer", "HEAD");
});